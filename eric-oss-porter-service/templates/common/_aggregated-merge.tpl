...
{{- define "eric-oss-porter-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-porter-service.mergeAnnotations" -}}
  {{- include "eric-oss-porter-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-oss-porter-service.mergeLabels" -}}
  {{- include "eric-oss-porter-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
